    ...
    <div class="page-content pt-7 pb-10 mb-10">
        ...
        <div class="container mt-8">
            ...
            <div class="order-results">
                ...
                <div class="overview-item">
                    <span><?= t('Date') ?></span>
                    <strong><?= Yii::$app->formatter->asDatetime($order->created_at) ?></strong>
                </div>
                <div class="overview-item">
                    <span><?= t('Phone') ?></span>
                ...
                <div class="overview-item">
                    <span><?= t('Total') ?></span>
                    <strong><?= Yii::$app->formatter->asSum($order->total_amount) ?></strong>
                </div>
                <div class="overview-item">
                    ...
                    <?php foreach ($order->orderItems as $item): ?>
                        <tr>
                            <td class="product-name"><?= $item->product->name ?><span> <i class="fas fa-times"></i>
											1</span></td>
                            <td class="product-price"><?= Yii::$app->formatter->asSum($item->price) ?></td>
                        </tr>
                    <?php endforeach ?>

                    <tr class="summary-subtotal">
                        <td>
                            <h4 class="summary-subtitle"><?= t('Subtotal') ?></h4>
                        </td>
                        <td class="summary-subtotal-price"><?= $order->subTotal ?></td>
                    </tr>
                    <tr class="summary-subtotal">
                        <td>
                            <h4 class="summary-subtitle"><?= t('Shipping') ?></h4>
                        </td>
                        <td class="summary-subtotal-price"><?= $order->shippingMethod ?></td>
                    </tr>
                    <tr class="summary-subtotal">
                        <td>
                            <h4 class="summary-subtitle"><?= t('Payment method') ?></h4>
                        </td>
                        <td class="summary-subtotal-price"><?= $order->paymentMethod ?></td>
                    </tr>
                    <tr class="summary-subtotal">
                        <td>
                        ...
                        <td>
                            <p class="summary-total-price"><?= Yii::$app->formatter->asSum($order->total_amount) ?></p>
                        </td>
                    </tr>
                    </tbody>
                </table>
            </div>
            <h2 class="title title-simple text-left pt-10 mb-2"><?= t('Billing Address') ?></h2>
