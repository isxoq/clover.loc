...
<?php if (!$node->isNewRecord || !empty($parentKey)): ?>
    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            ...
            <?= $form->field($node, 'status')->widget(\kartik\widgets\SwitchInput::classname(), [
...
//                'category' => "Maqola kategoriyalari",
                ...
                'other' => "Boshqa",
                   ...
                   var t =  $(this).val()
                    ...
                    else if (t === "category" || t === "page" || t == "catalog" || t == "sub_catalog" || t == "c-action" || t == "magazine"){
                        $.ajax({
                            url: menu_url,
                            data: {type:t},
                            type: "get",
            ...
            <div class="form-group highlight-addon field-tree-url_value">
                ...
                <div id="menu-value">
                    ...
                    elseif ($node->url_type == 'page')
                        echo $form->field($node, 'url_value')
                            ->dropdownList(ArrayHelper::map(\backend\modules\pagemanager\models\Page::find()->all(), 'id', 'title'), ['prompt' => "Sahifani tanlang"])
                            ->label(false);
                    elseif ($node->url_type == 'magazine')
                        echo $form->field($node, 'url_value')
                            ->dropdownList(ArrayHelper::map(\backend\models\Magazine::find()->all(), 'id', 'title'), ['prompt' => "Maqolani tanlang"])
                            ->label(false);
