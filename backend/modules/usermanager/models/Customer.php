...
class Customer extends \common\models\User
{
    ...
    public $password;
    const SCENARIO_CREATE = "create_customer";
    const SCENARIO_UPDATE = "update_customer";
    ...
    public function scenarios()
    {
        return array_merge(parent::scenarios(), [
            self::SCENARIO_CREATE => ['first_name', 'last_name', 'phone', 'address', 'password'],
            self::SCENARIO_UPDATE => ['first_name', 'last_name', 'phone', 'address', 'password', 'status']
        ]);
    }
    ...
    public function rules()
    {
        return [
            ...
            [['first_name', 'last_name', 'phone', 'address', 'password'], 'required', 'on' => self::SCENARIO_CREATE],
            [['first_name', 'last_name', 'phone', 'address'], 'required', 'on' => self::SCENARIO_UPDATE],
